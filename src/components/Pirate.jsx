      ...
      <div className="container">
        <div className={pirateStyles.content}>
          <div className={pirateStyles["title-container"]}>
            ...
            <p className={pirateStyles.subtitle}>Как говорят все пираты:  «Йо-хо-хо и портовые<button className={pirateStyles.blur} onClick={() => setBlur(!blur)}>{blur ? <img src={blurImage} alt="шлюпки"></img>: `шлюпки`}</button>».  Ну или как-то так. Еще пираты ходят в кино только на пиратские фильмы и имеют сертификат об обучении.</p>
          </div>
